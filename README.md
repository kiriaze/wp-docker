...
### If port allocated errors pop up, run these below
```
sudo lsof -i :8080
sudo killall httpd
...
A Docker Wordpress development environment by the team at [Visible](https://visible.vc/) and some awesome [contributors](https://github.com/kiriaze/wp-docker/graphs/contributors). Our goal is to make Wordpress development slightly less frustrating.
...
```
# copy the files
git clone https://github.com/kiriaze/wp-docker.git
...
You can find Development instructions in the [Wiki](https://github.com/kiriaze/wp-docker/wiki/Development).
